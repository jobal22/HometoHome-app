            ...
            <div className='Help'>
                ...
                <div className='HelpInfo'>
                    ...
                    <section className='helpF'>
                        ...
                        <p className='helpP'>
                            There are four List (<b>Unengaged Addresses</b>, <b>Follow-Up: Needs Gospel</b>, 
                            <b>Follow-Up: Heard Gospel</b>, <b>Engaged with Salvations</b>). As the Users
                            interact with each home and update the 'address information,' the
                        ...
                        <p className='helpP'>
                            The <b>Unengaged Addresses List</b> contains addresses where the 'Gospel Presentation'
                            is set to 'N/A' and 'New Salvations' is set to '0'.
                        </p>
                        <p className='helpP'>
                            The <b>Follow-Up: Needs Gospel List</b> contains addresses where the 'Gospel Presentation'
                            is set to 'no' and 'New Salvations' is set to '0'.
                        </p>
                        <p className='helpP'>
                            The <b>Follow-Up: Heard Gospel List</b> contains addresses where the 'Gospel Presentation'
                            is set to 'yes' and 'New Salvations' is set to '0'.
                        </p>
                        <p className='helpP'>
                            The <b>Engaged with Salvations List</b> contains addresses where the 'Gospel Presentation'
